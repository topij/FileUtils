...
"""
    ...
    try:
        # Simple DOCX
        simple_docx = "This is a test document for DOCX format. It contains basic text content."
    ...
    try:
        # Simple PDF
        simple_pdf = "This is a test document for PDF format. It contains basic text content."
